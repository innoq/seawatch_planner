...
class TestAvailabilityView(TestBases.TestBase):
        ...
        def test_views__availabilities__get__should_show_existing_availabilities(self):
            ...
            profile: Profile = self.profile
            profile.save()
            availability1 = Availability(profile=profile, start_date='2002-02-02', end_date='2010-10-10', comment='comment1')
            availability1.save()
            availability2 = Availability(profile=profile, start_date='2012-12-12', end_date='2013-01-01', comment='comment2')
            availability2.save()
