...
urlpatterns = [
    ...
    path('profile/add/', profile.ProfileCreateView.as_view(), name='profile_create'),
    ...
    path('documents/add/', document.DocumentCreateView.as_view(), name='document_create'),
    ...
    path('questions/edit/', question.AnsweringQuestionsView.as_view(), name='question_answer'),
    path('positions/edit/', position.PositionUpdateView.as_view(), name='requested_position_update'),
    path('skills/edit/', skill.SkillsUpdateView.as_view(), name='skill_update'),
    path('availabilities/', availability.AvailabilityListView.as_view(), name='availability_list'),
