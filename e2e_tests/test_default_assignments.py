...
class TestDefaultAssignment(TestCases.SeleniumLoginTestCase):
    ...
    def setUp(self) -> None:
        ...
        ship.save()
        self.position = Position.objects.create(name='The Butler')
        self.quantity = '2'
    ...
    def test_add_default_assigment(self):
        ...
        self.assertEquals(self.browser.current_url,
                          self.live_server_url + reverse('default_assignment_list',
        ...
        self.assert_active_navbar()
        self.assertEquals(self.browser.current_url,
                          self.live_server_url + reverse('default_assignment_create',
                                                         kwargs={'ship_id': self.ship.id}))
